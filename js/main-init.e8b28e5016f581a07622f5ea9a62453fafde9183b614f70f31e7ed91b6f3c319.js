(() => {
  // ns-hugo-params:/tmp/hugo_cache_runner/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.8.4/assets/js/local-storage/index.ts
  var local_storage_default = { baseURL: "https://iliubang.cn/" };

  // ns-hugo-imp:/tmp/hugo_cache_runner/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.8.4/assets/js/local-storage/index.ts
