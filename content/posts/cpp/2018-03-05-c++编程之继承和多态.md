---
title: c++编程之继承和多态
description: "超类（基类）和子类（派生类）：在面向对象程序设计中，我们通常使用继承来避免代码冗余。在 C++中，继承的语法规则如下。"
date: 2018-03-05
categories: [C++工程]
tags: [cpp]
authors: ['liubang']
...
![](/images/2018-03-05/ClassDiagram_MovablePoint.png#center "ClassDiagram_MovablePoint")
...
![](/images/2018-03-05/ClassDiagram_Shape.png#center "ClassDiagram_Shape")
