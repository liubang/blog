---
title: c++编程之OOP示例
description: "通过一个 Time 类示例演示 C++ 面向对象设计、链式调用与接口演进。"
date: 2018-03-02
categories: [C++工程]
tags: [cpp]
authors: ['liubang']
...
![](/images/2018-03-02/ClassDiagramComplex.png#center "ClassDiagramComplex")
...
![](/images/2018-03-02/ClassDiagramDate.png#center "ClassDiagramDate")
