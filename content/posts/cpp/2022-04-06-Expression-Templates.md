...
![my_vector1](/images/2022-04-07/my_vector1.png#center "未优化版本的汇编输出")

我们能发现，对于`x + x + y * y`这行代码，执行的过程为:

![my_vector1.1](/images/2022-04-07/my_vector1.1.png#center "未优化版本的执行过程")
...
![my_vector2.1](/images/2022-04-07/my_vector2.1.png#center "优化版本的执行过程：无临时变量")
...
![my_vector2.2](/images/2022-04-07/my_vector2.2.png#center "Expression Templates 优化后的汇编输出")

汇编代码片段中表达式虽然很长，但是仔细看还是能看清它的结构。下面是一个简化版的代码生成图，用来说明模板的生成过程：

![Exression](/images/2022-04-07/Exression.png#center "Expression Templates 的模板展开过程")
