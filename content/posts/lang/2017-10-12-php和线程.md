---
title: PHP和线程
description: "介绍 PHP 与线程模型之间的关系，并结合参考资料理解相关实现与限制。"
categories: [语言与编译]
tags: [c, php]
authors: ['liubang']
date: 2017-10-12
...
![进程](/images/2017-10-13/up.png#center "进程的内存结构")

线程

![线程](/images/2017-10-13/thread_structure.png#center "线程的内存结构")

进程和线程的关系
![进程和线程的关系](/images/2017-10-13/process_thread.gif#center "进程和线程的关系")
...
![](/images/2017-10-13/threads_lifetime.gif#center "线程的生命周期状态转换")
...
![并发](/images/2017-10-13/threads_concurrency.png#center "并发：多个线程在同一 CPU 上交替执行")

平行：

![平行](/images/2017-10-13/threads_parallelism.png#center "平行：多个线程在不同 CPU 上同时执行")
...
![](/images/2017-10-13/php_extensions_resources.png#center "PHP 扩展的 TSRM 全局变量存储结构")
