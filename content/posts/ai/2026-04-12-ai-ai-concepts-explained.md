...
![LLM 文字接龙流程图](/images/2026-04-12/llm-next-token.svg "LLM 文字接龙流程图")
...
![Tokenizer 编解码流程图](/images/2026-04-12/tokenizer-flow.svg "Tokenizer 编解码流程图")
...
你可能有过这样的体验：跟大模型聊天时，它好像能记住你之前说过的话。比如你告诉它「我叫小明」，后来再问「我叫什么」，它还是能回答出来。
...
![Context 与 Context Window 示意图](/images/2026-04-12/context-window.svg "Context 与 Context Window 示意图")
...
![RAG 检索增强生成流程图](/images/2026-04-12/rag-flow.svg "RAG 检索增强生成流程图")
...
![Prompt 分层示意图](/images/2026-04-12/prompt-layers.svg "Prompt 分层示意图")
...
![Tool 调用完整流程图](/images/2026-04-12/tool-call-flow.svg "Tool 调用完整流程图")
...
![MCP 统一标准示意图](/images/2026-04-12/mcp-standard.svg "MCP 统一标准示意图")
...
![Agent 多步骤执行流程图](/images/2026-04-12/agent-loop.svg "Agent 多步骤执行流程图")
...
![Agent Skill 结构图](/images/2026-04-12/skill-structure.svg "Agent Skill 结构图")
...
![AI 技术栈全景图](/images/2026-04-12/ai-stack-overview.svg "AI 技术栈全景图")
