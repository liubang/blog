---
title: 彻底掌握malloc
description: "系统梳理 malloc 的工作机制、堆内存布局，以及常见分配策略与实现细节。"
...
![heap](/images/2017-03-17/heap.png#center "堆的内存组织结构")
...
![heap1](/images/2017-03-17/heap1.png#center "带 page 边界的内存组织结构")
...
![chunk](/images/2017-03-17/chunk.png#center "内存块的 meta-data 结构")
...
![unsplit_blocks](/images/2017-03-17/unsplit_blocks.png#center "未分裂的内存块")

![split_blocks](/images/2017-03-17/split_blocks.png#center "分裂后的内存块")
